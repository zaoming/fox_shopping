...
public class TrolleyDetailVo {
	private int trollyDetailID;
	private int trollyID;
	private int GoodsID;
	private String GoodsName;
	private float GoodsPrice;
	private float GoodsCoun;
	private int Goodsbuyed;
	private String createDate;
	private String else2;
	private String else3;
	public int getTrollyDetailID() {
		return trollyDetailID;
	}
	public void setTrollyDetailID(int trollyDetailID) {
		this.trollyDetailID = trollyDetailID;
	}
	...
	public int getGoodsbuyed() {
		return Goodsbuyed;
	}
	public void setGoodsbuyed(int goodsbuyed) {
		Goodsbuyed = goodsbuyed;
	}
