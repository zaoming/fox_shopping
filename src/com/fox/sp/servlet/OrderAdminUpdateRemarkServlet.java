...
public class OrderAdminUpdateRemarkServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public OrderAdminUpdateRemarkServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getSession().getAttribute("userTrueName") == null
			...
			System.out.println("orderRemark=" + orderRemark);

			if (ioas.updateAdminOrderRemark(orderRemark, orderID)) {
				response.sendRedirect("orderAdminQueryAll");
			}
		}
