...
public class MemberAddrDeleteServlet extends HttpServlet {
	IMemberAddrService imas = new MemberAddrServiceImpl();
	/**
	 * Constructor of the object.
	 */
	public MemberAddrDeleteServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String memberAddrID = request.getParameter("memberAddrID");
		if(imas.deleteMemberAddr(Integer.parseInt(memberAddrID))){
