...
public class MemberAddrQueryAllServlet extends HttpServlet {
	IMemberAddrService imas = new MemberAddrServiceImpl();
	
	/**
	 * Constructor of the object.
	 */
	public MemberAddrQueryAllServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect(request.getContextPath()+"/order/memberAddr.jsp");
	}
