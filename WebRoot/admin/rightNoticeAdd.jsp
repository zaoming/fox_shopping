...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 公告添加 </span></td>
              </tr>
            </table></td>
  ...
  <tr>
	...
	<form action="../noticeAdd" method="post" >
       	<b>公告标题：</b><input size="30px" type="text" name="placardTitle"/>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<br />
        <b>公告内容：</b><br />
       <textarea rows="5" cols="40" name="placardContent"></textarea> <br /><br />
      	<b>生效时间：</b> 
	    ...
	    <br /> <br /> 
       <input type="submit" style="font-weight: bolder;color: red;" value="提交" onmouseover="shijian();"/>
    </form>
	</div>		
    </table>
