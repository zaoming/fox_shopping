    ...
    <td>
    	...
    	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" align="center">
		    ...
		    <%
		    	...
		    	String adsPic = request.getParameter("adsPic");
		     %>
		    <form action="../adUpdate">
		    <img src="<%=adsPic %>" name="pic" /><br /><br />
		    ...
		    <br /> <br />
		    <input type="submit" value="提交修改" style="font-weight: bolder;color: red;" onmouseover="shijian();"/>
	 	 	</form>
