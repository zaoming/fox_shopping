          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 公告信息列表</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="6%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">公告标题</span></div></td>
        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">公告内容</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">发布时间</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">失效时间</span></div></td>
      ...
      <c:forEach items="${sessionScope.noticelist }" var="nc">
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">
          <input type="checkbox" name="checkbox2" id="checkbox2" />
        </div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.placardTitle }</div></td>
        <td height="100" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${nc.placardContent }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.iSsueDate }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.expireDate }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.creater }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.createDate }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.updater }</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${nc.updateDate }</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../noticeDelete?nID=${nc.placardID }">删除</a> </div></td>
