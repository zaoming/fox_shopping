...
<div id="requestOldCartStatus"></div> 
           ...
           <hr color="#A71F24" size="" align="center"/>
          <div id="main">
          

			<h1 align="center">${sessionScope.placardTitle }</h1>
		 	<br /><br />
	      <div id="right"><b>时间：</b>${sessionScope.updateDate }</div>
	      <br />
	      <HR style="border:3 dashed #ff0033" width="100%"  NOSHADE></HR>

	      <br />
	      <p style="font-family: fantasy;font-weight: bolder;" align="center">
	      &nbsp;&nbsp;&nbsp;&nbsp;${sessionScope.placardContent }
	      <p>&nbsp;</p><br><p>&nbsp;</p><br><p>&nbsp;</p>
 		</div>
