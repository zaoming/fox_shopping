...
<script type="text/javascript" async="" src="./regedit_files/ga.js"></script>
<script type="text/javascript" src="./regedit_files/jquery-1.4.2.min.js"></script>
  ...
  <div id="simple_header">
      <div class="simplelogo">
      	<a href="<%=path %>/index.jsp" target="_blank">
	      			<img src="./regedit_files/91logo.png" height="55">
      	</a>
      </div>
      <div class="simplenav"> 
           		<p id="unloginP" class=""><strong>您好</strong>，欢迎光临91商城！<a href="<%=path %>/member/login.jsp">[请登录]</a>，新用户？<a href="">[免费注册]</a></p>
          
          <div class="tr"><a href="" target="_blank">帮助中心</a></div>
      </div>
      <div class="clear"></div>
  </div>
...
<div id="container">
	<form action="<%=path %>/member/memberRegedit" method="post" name="registerform" id="registerform"> 
			...
			<div id="content">
				<div class="regBox" id="innerContent">
					<div class="tBox">
						...
						<p>
							<label>确认密码：</label>
							<input id="password2" name="password2" type="password" onblur="checkPassword2OnBlur();" oncopy="return false;" oncut="return false;" onpaste="return false;" onfocus="" class="fl" onkeyup="showoff(&#39;password2_desc&#39;);" />
						...
						<p class="verCode">
							...
							<img id="valid_code_pic" alt="" src="./image.jsp" class="yanzheng" style="border:0px;"><span class="vlidCdSpan">看不清，<a href="javascript:refresh_valid_code();">换一张</a></span>
					...
					<span id="contract_desc" style="display:none" class="errorinfo">请选择"91商城"服务协议方可注册</span>
					<p class="yhdSerLink">
									<a ;="" onclick="window.open(&#39;http://www.yihaodian.com/cms/view.do?topicId=22209&#39;,&#39;&#39;, &#39;width=600,height=600,scrollbars=1&#39;)" href="https://passport.yihaodian.com/passport/register_input.do#">《91商城服务协议》</a>
						</p>
						<div class="btnBox">
						   <a onclick="javascript:mySubmit();return false;"><img src="./regedit_files/agree.png"></img></a>
					    </div>
					</div>
				</div>
			</div>
	...
	<div id="simplefooter"><a rel="nofollow" target="_blank" href="http://www.miibeian.gov.cn/">沪ICP备10215750号</a>|<a target="_blank" href="http://image.yihaodianimg.com/images/licence.JPG">营业执照</a><p>Copyright © 91商城网上超市 2007-2012， All Rights Reserved</p></div><script type="text/javascript">
 var _gaq = _gaq || [];
