...
<script>
	function submits(){
		if(checkPwd()){
			document.getElementById("updateToPayPwdForm").submit();
		}
	}
	function checkPwd(){
...
<link rel="stylesheet" type="text/css" href="./editinfo_files/pop_compare.css" media="all">
	...
	<div class="w">
		...
		<ul class="fr lh">
			...
			<li class="fore2"><a href="<%=path %>/orderSerlvetQueryAll">">我的订单</a></li>
...
<div alt="" id="container">
	<div class="breadcrumb">
		您现在的位置：<a class="aBlu" href="">91商城</a> &gt; <a class="aBlu" href="">我的91商城</a> &gt; 修改支付密码
	</div>
<div style="display: block; float: left;" id="myYihaodianLeftMenu" class="columnleft">
		<dl>
			<dt>订单查询</dt>
			<dd>&gt;<a href="<%=path %>/orderSerlvetQueryAll">">我的订单</a></dd>
		...
		<dl>
			...
			<dd class="current">&gt;<a href="<%=path %>/member/updateToPayPwd.jsp">修改支付密码</a></dd>
    ...
    <ul class="ul_tab mb10" alt="1">
      <li class="orderTab on" id="tab1"><s></s>修改支付密码</li>
    </ul>

	
	      <form method="post" name="updateToPayPwd" id="updateToPayPwdForm" action="<%=path %>/member/memberUpdateToPayPwd?memberID=${memberID }">
	    		<ul class="info_form">
	     			<li><label>原始密码</label><input type="password" name="oldPwd" id="oldPwd" /><br/></li>
	     			<li><label>新 &nbsp;密&nbsp;码</label><input type="password" name="newPwd" id="newPwd" /><br/></li>
	     			<li><label>新 &nbsp;密&nbsp;码</label><input type="password" name="newPwd1" id="newPwd1" /><br/></li>
