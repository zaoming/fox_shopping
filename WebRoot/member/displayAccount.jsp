...
<!-- saved from url=(0049)http://my.yihaodian.com/account/displayAccount.do -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script src="./displayAccount_files/info.do"></script><script type="text/javascript" async="" src="./displayAccount_files/ga.js"></script>

	<title>我的91商城-账户查询</title>

<meta name="Keywords" content="我的91商城-账户查询">
<meta name="Description" content="我的91商城-账户查询">


<!--css start-->
<link href="./displayAccount_files/global_site_base.css" rel="stylesheet" type="text/css">



    <link href="./displayAccount_files/displayAccount.css" rel="stylesheet" type="text/css">
<!--css end-->
<!--js start-->
...
<link rel="stylesheet" type="text/css" href="./displayAccount_files/global_yhdLib.css"><script type="text/javascript" src="./displayAccount_files/global_yhdLib.js"></script><script type="text/javascript" src="./displayAccount_files/global_login_frame.js"></script></head>
<link rel="stylesheet" type="text/css" href="./displayAccount_files/base.css" media="all">
<link rel="stylesheet" type="text/css" href="./displayAccount_files/plist20120412.css" media="all">
<link rel="stylesheet" type="text/css" href="./displayAccount_files/pop_compare.css" media="all">
	  <body>
	   <div id="shortcut">
	<div class="w">
		<ul class="fl lh">
			<li class="fore1 ld"><b></b><a href="">收藏91<span>商城</span></a></li>
	...
	<div class="w" id="header">
		<div id="logo" class="ld"><a href="<%=path %>/index.jsp"><b></b><img src="./displayAccount_files/91logo.png" width="259" height="50" alt="91商城"></a></div><!--logo end-->
		<div id="search">
		...
		<div id="my360buy">
			<dl>
				<dt class="ld"><s></s><img src="./displayAccount_files/blank.gif" width="24" height="24" alt="头像"><a href="http://home.360buy.com/">我的91</a><b></b></dt>
...
<input type="hidden" id="currentSiteUrlPrefix" value="">
<div id="container">
	<div class="breadcrumb">
		您现在的位置：<a class="aBlu" href="">91商城</a> &gt; <a class="aBlu" href="">我的91商城</a> &gt; 账户查询
	</div>
<div style="display: block; float: left;" id="myYihaodianLeftMenu" class="columnleft">
		...
		<dl>
			<dt>账户信息</dt>
			<dd class="current">&gt;<a href="<%=path %>/member/memberQueryAmount?memberID=${memberID }">账户查询</a></dd>
	...
	<img src="./displayAccount_files/leftfooter.gif" />
</div>
	<div class="columnright">
			<ul class="ul_tab mb10">
					<li class="on"><s></s>我的91商城</li>
		    		<li onclick=""><s></s>我的1号商城</li>
		    </ul>
		
		<div class="account_box">
			
			
			     	您当前的账户余额为<em>¥${memberAmount }</em><br>
			     	
   		</div>
		
		<input type="hidden" value="0" id="isDisplayAll" />
		<input type="hidden" value="" id="withdrawRuleUrl" />
		<form action="<%=path %>/member/memberChongZhi">
			<input type="hidden" value="${memberID }" name="memberID" />
			<input type="text" name="money" id="money"/><br/>
			<input type="submit" value="充值"/ onclick="return checks()"/>
		</form>
		<script>
			function checks(){
    ...
    if(lazyLoadImageObjArry){ 
		...
		<div class="wrap mt" id="footer">
			   <div class="footer_service">
		          <a href="http://www.yihaodian.com/deliveryinfo/deliveryInfo.do" target="_blank" onclick="addTrackPositionToCookie(&#39;1&#39;,&#39;YHD_HOME_manbai&#39;);"><span class="s1"></span>满百包邮</a><a href="http://www.yihaodian.com/cms/view.do?topicId=18993" target="_blank" onclick="addTrackPositionToCookie(&#39;1&#39;,&#39;YHD_HOME_zhengpin&#39;);"><span class="s2"></span>正品保障</a><a href="http://www.yihaodian.com/cms/view.do?topicId=18982" target="_blank" onclick="addTrackPositionToCookie(&#39;1&#39;,&#39;YHD_HOME_shouhou&#39;);"><span class="s3"></span>售后无忧</a>
	           </div>
		  
			  	  <p><a href="http://www.yihaodian.com/cms/view.do?topicId=8101&merchant=1" target="_blank">关于91商城</a>|<a href="http://www.yihaodian.com/cms/view.do?topicId=8121&merchant=1" target="_blank">我们的团队</a>|<a href="http://union.yihaodian.com/passport/login_input.do" target="_blank">网站联盟</a>|<a href="http://www.yihaodian.com/friendlink/index.do" target="_blank">友情链接</a>|<a href="http://www.yihaodian.com/pop-words/index.html" target="_blank">热门搜索</a>|<a href="http://www.yihaodian.com/cms/view.do?topicId=14120&merchant=1" target="_blank">诚征英才</a>|<a href="http://www.yihaodian.com/cms/view.do?topicId=8122&merchant=1" target="_blank">媒体报道</a>|<a href="http://www.yihaodian.com/cmsPage/show.do?pageId=12368" target="_blank">申请成为供应商</a>|<a href="http://supplier.yihaodian.com/" target="_blank">供应商登录/注册</a></p><p><a target="_blank" href="http://www.miibeian.gov.cn/">沪ICP备10215750号</a>| <a target="_blank" href="http://image.yihaodianimg.com/images/licence.JPG">营业执照</a></p><p>Copyright © 91商城网上超市 2007-2012，All Rights Reserved </p>
		  <small id="footerbanner2LazyLoad" class="footer_pic_link"> 
		    
		      <a href="" target="_blank"><img src="./displayAccount_files/blank.gif" original="http://image.yihaodianimg.com/member/global/images/unionpay.gif"></a>
			  <a href="" target="_blank"><img src="./displayAccount_files/blank.gif" original="http://image.yihaodianimg.com/member/global/images/footer_pic_04.gif"></a>
			  <a target="_blank" href=""><img src="./displayAccount_files/blank.gif" original="http://image.yihaodianimg.com/member/global/images/footer_pic_05.gif"></a>
		  	  <span><a href="" target="_blank"><img src="./displayAccount_files/blank.gif" original="http://image.yihaodianimg.com/member/global/images/shgs.gif"></a></span>
		   </small>
		  
		</div>
		    <!--js start-->
 <!--无页面级头部js时, 全局头部js下移-->
	      <script type="text/javascript" src="./displayAccount_files/global_site_top.js" charset="utf-8"></script>
	      <script type="text/javascript" src="./displayAccount_files/accountDisplay.js" charset="utf-8"></script>
	    <script type="text/javascript" src="./displayAccount_files/global_site_bottom.js" charset="utf-8"></script>
	    <!--js end-->
<div>
...
<div class="tixian_box">
	...
	<ul>
		<li class="quxian_num">
			<label>您当前的手机号：</label><ins>null</ins>
			<button id="timeToDeadLine_account" class="tixian_viliate" onclick="sendPhoneCheckAccount()">发送验证信息</button>
		</li>
		<li id="send_msg" class="send_msg"></li>
		<li>
			<label>请输入验证码：</label>
	...
	<p><button onclick="checkPhoneCodeForAccount()">确定</button></p>
</div>
</div></body></html>